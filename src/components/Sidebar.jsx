  ...
  return (
    <>
      <aside
        className={
          isOpen
            ? `fixed lg:static z-[100] flex flex-col translate-x-0 transition-all duration-300 w-[250px] bg-[#1F2027] shadow-xl h-screen lg:block`
            : `fixed lg:static flex flex-col translate-x-[-250px] w-[250px] bg-[#1F2027] shadow-xl h-screen hidden`
        }
      >
